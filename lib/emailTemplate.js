          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background-color:#ffffff;border-radius:12px;border:1px solid #e8eaef;box-shadow:0 1px 3px rgba(15,23,42,0.06);">
            <tr>
              <td style="padding:40px 40px 8px 40px;">
                <p style="margin:0;font-size:13px;font-weight:600;letter-spacing:0.02em;color:#6b7280;">NoraX</p>
                ...
                <p style="margin:14px 0 0 0;font-size:15px;line-height:1.65;color:#4b5563;">Vous venez de demander un accès à votre compte NoraX. Pour poursuivre en toute simplicité, ouvrez simplement l’application depuis le bouton ci-dessous : nous vous y reconduirons pour finaliser la connexion de manière sécurisée.</p>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="border-radius:8px;background-color:#4f46e5;">
                      <a href="${safeUrl}" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;border-radius:8px;">Ouvrir NoraX</a>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:20px 40px 36px 40px;">
                ...
                <p style="margin:28px 0 0 0;font-size:14px;line-height:1.6;color:#374151;">L’équipe NoraX</p>
...
function buildSignInEmailText(signInLink) {
  ...
  return [
    ...
    "Bonjour,",
    "",
    "Vous avez demandé à vous connecter à votre compte NoraX. Pour finaliser la connexion, ouvrez le lien suivant dans un navigateur ou suivez les instructions de votre appareil :",
    "",
    link,
    "",
