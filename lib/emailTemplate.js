/**
 * HTML + texte pour le magic link Firebase (pas d’URL brute dans le HTML).
...
/**
 * Version texte : lien présent ici uniquement (pas dans le HTML).
...
function buildSignInEmailText(signInUrl) {
  return [
    ...
    "",
    "Tap the button below to open the app and finish signing in.",
    "",
    signInUrl,
    "",
